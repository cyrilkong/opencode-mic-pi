...
- 本项目是 OpenCode 插件，目标是向 Nub 插件发布前进，而不是发展成独立多智能体平台。
...
6. 已有明确 QA 与验收流程
7. Nub 插件安装路径、配置路径、默认行为、README 叙事一致
8. 对外承诺不超过当前真实能力
